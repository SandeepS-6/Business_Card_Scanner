...
export let tickets: SupportTicket[] = [
  {
    ...
    messages: [
      { id: 'm1', author: 'Maya Patel', body: 'Glossy laminate cards often need review. Can we improve preprocessing tips in the UI?', at: '2026-09-09T11:00:00Z' },
      {
        id: 'm2',
        author: 'Support Bot',
        body: 'Thanks — we recommend capturing at an angle to reduce glare. Sharing a short guide.',
        at: '2026-09-09T12:10:00Z',
        status: 'read',
        attachments: [
          {
            id: 'att1',
            name: 'glare-capture-guide.pdf',
            size: 248320,
    ...
    history: [
      { id: 'h1', text: 'Ticket created by Maya Patel', at: '2026-09-09T11:00:00Z' },
      { id: 'h2', text: 'Assigned to Support Bot', at: '2026-09-09T11:01:00Z' },
      { id: 'h3', text: 'Reply added by Support Bot', at: '2026-09-09T12:10:00Z' },
    ],
  },
  {
    id: 'tkt-1038',
    ...
    history: [
      { id: 'h4', text: 'Ticket created by Ava Chen', at: '2026-09-02T09:00:00Z' },
      { id: 'h5', text: 'Assigned to Billing Desk', at: '2026-09-02T09:05:00Z' },
      { id: 'h6', text: 'Status → resolved', at: '2026-09-03T10:00:00Z' },
    ],
  },
  {
    id: 'tkt-1031',
    orgId: 'org-nexus',
    subject: 'WhatsApp template approval delay',
    category: 'whatsapp',
    priority: 'urgent',
    status: 'pending',
    ...
    messages: [
      { id: 'm5', author: 'Jordan Lee', body: 'Template still pending Meta review after 48h.', at: '2026-09-08T08:00:00Z' },
    ],
    history: [
      { id: 'h7', text: 'Ticket created by Jordan Lee', at: '2026-09-08T08:00:00Z' },
      { id: 'h8', text: 'Assigned to Support Bot', at: '2026-09-08T08:02:00Z' },
      { id: 'h9', text: 'Assigned to Maya Patel', at: '2026-09-08T10:00:00Z' },
      { id: 'h10', text: 'Status → pending', at: '2026-09-09T14:00:00Z' },
    ],
  },
  {
    id: 'tkt-1020',
    orgId: 'org-nexus',
    subject: 'CRM sync failed for HubSpot',
    category: 'crm',
    priority: 'high',
    status: 'open',
    ...
    messages: [
      { id: 'm6', author: 'Sam Rivera', body: 'Contacts not pushing after reconnect.', at: '2026-09-07T16:00:00Z' },
    ],
    history: [{ id: 'h11', text: 'Ticket created by Sam Rivera', at: '2026-09-07T16:00:00Z' }],
  },
  {
    id: 'tkt-1012',
    orgId: 'org-nexus',
    ...
    messages: [],
    history: [
      { id: 'h12', text: 'Ticket created by Priya Shah', at: '2026-08-28T12:00:00Z' },
      { id: 'h13', text: 'Assigned to Support Bot', at: '2026-08-28T12:05:00Z' },
      { id: 'h14', text: 'Status → closed', at: '2026-08-29T09:00:00Z' },
    ],
  },
]
